...
PPC.Save_Params(rho_opt, 'params/10by10straightwaveguide_ez_w1_wp.csv')
print(PPC.Rho_to_Eps(rho = rho_opt, plasma = True, w_src = w))
PPC.Params_to_Exp(rho = rho_opt, src = 'src', plasma = True)
PPC.Viz_Sim_abs_opt(rho_opt, ['src'], 'plots/StraightWaveguide_Ez_w1_wp.pdf', plasma = True)
PPC.Viz_Obj(obj, 'plots/StraightWaveguide10by10_Ez_w1_wp_obj.pdf')
