...
rho_opt = PPC.Optimize_Waveguide(rho, bounds, 'src', 'prb', 0.010, 300)
PPC.Save_Params(rho_opt, 'params/10by10straightwaveguide_hz_w1.csv')
print(PPC.Rho_to_Eps(rho_opt, bounds))
PPC.Params_to_Exp(rho_opt, bounds, 'src', 0)
PPC.Viz_Sim_abs_opt(rho_opt, bounds, ['src'], 'plots/StraightWaveguide_Hz_w1.pdf')
